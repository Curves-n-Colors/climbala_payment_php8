...
class PayController extends Controller
{
    ...
    public function hbl_pay($entry, $encrypt, $request)
    {
        ...
        $signData = hash_hmac('SHA1', $signature_string, env('SECRET_CODE'), false);
    ...
    public function hblFrontendResponse(Request $request, $url_encryption)
    {   
        try {
    ...
    public function hblBackendResponse(Request $request)
    {
        // PaymentHBL::_check_backend($request->all());
    }
}
